...
public class ZongShiActiveTaskActivity extends Activity implements OnClickListener, IMessageDialogListener {
	...
	private void initView() {
		...
		if (pm != null) {
			activeTask = new ActiveTask(ZongShiActiveTaskActivity.this, getResourceListTask(), pm.getActiveTaskId());
			activeTask.execute();
		}
	...
	public void onClick(View arg0) {
		switch (arg0.getId()) {
			...
			case R.id.rejectButton:
				showEditTextInfo(AUDIT_CONFIRM_2, ZongShiActiveTaskActivity.this, getString(R.string.rejectButton), this);
				break;
